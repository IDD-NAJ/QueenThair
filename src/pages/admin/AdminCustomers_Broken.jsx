          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200">
              {filteredCustomers.map(customer => {
                ...
                const totalSpent = customer.orders?.reduce((sum, order) => sum + (order.grand_total || 0), 0) || 0;
                const primaryAddress = customer.addresses?.find(addr => addr.is_default) || customer.addresses?.[0];
                  ...
                  <tr key={customer.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        {primaryAddress ? (
                          <div>
                            <p>{primaryAddress.city}, {primaryAddress.state_region}</p>
                            <p className="text-gray-500">{primaryAddress.country}</p>
                          </div>
                        ) : (
